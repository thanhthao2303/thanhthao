                ...
                <form action="{{ route('books.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        <div class="form-item">
                            ...
                            <input type="text" id="tieuDe" name="tieuDe" value="{{ old('tieuDe') }}">
                            @error('tieuDe')
                        ...
                        <div class="form-item">
                            ...
                            <input type="text" id="tacGia" name="tacGia" value="{{ old('tacGia') }}">
                            @error('tacGia')
                            <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-item">
                            ...
                            <input type="text" id="nhaXuatBan" name="nhaXuatBan" value="{{ old('nhaXuatBan') }}">
                            @error('nhaXuatBan')
                            <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        <div class="form-item">
                            ...
                            <input type="text" id="namXuatBan" name="namXuatBan" value="{{ old('namXuatBan') }}">
                            @error('namXuatBan')
                            <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-item">
                            ...
                            <input type="text" id="nhaCungCap" name="nhaCungCap" value="{{ old('nhaCungCap') }}">
                            @error('nhaCungCap')
                            <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        <div class="form-item">
                            ...
                            <input type="text" id="hinhThucBia" name="hinhThucBia" value="{{ old('hinhThucBia') }}">
                            @error('hinhThucBia')
                            <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-item">
                            ...
                            <input type="text" id="soLuong" name="soLuong" value="{{ old('soLuong') }}">
                            @error('soLuong')
                            <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-item">
                            ...
                            <input type="text" id="soTrang" name="soTrang" value="{{ old('soTrang') }}">
                            @error('soTrang')
                            <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        <div class="form-item">
                            <label for="trongLuong">Trọng lượng (gr):</label>
                            <input type="text" id="trongLuong" name="trongLuong" value="{{ old('trongLuong') }}">
                            @error('trongLuong')
                            <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-item">
                            ...
                            <input type="text" id="nguoiDich" name="nguoiDich" value="{{ old('nguoiDich') }}">
                            @error('nguoiDich')
                            <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-item">
                            ...
                            <input type="text" id="ngonNgu" name="ngonNgu" value="{{ old('ngonNgu') }}">
                            @error('ngonNgu')
                            <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-item">
                            ...
                            <input type="text" id="giaBan" name="giaBan" value="{{ old('giaBan') }}">
                            @error('giaBan')
                            <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-item">
                            ...
                            <input type="text" id="tonKho" name="tonKho" value="{{ old('tonKho') }}">
                            @error('tonKho')
                            <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-item">
                            ...
                            <input type="text" id="soLuongDaBan" name="soLuongDaBan" value="{{ old('soLuongDaBan') }}">
                            @error('soLuongDaBan')
                            <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-item">
                            ...
                            <input type="text" id="theLoai" name="theLoai" value="{{ old('theLoai') }}">
                            @error('theLoai')
                            <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-item description-group"style="width: 100%; display: flex;">
                        ...
                        <textarea id="moTaSach" name="moTaSach" ; height: 50px; >{{ old('moTaSach') }}</textarea>
                        @error('moTaSach')
                        <div class="error-message">{{ $message }}</div>
                        @enderror
                    </div>
