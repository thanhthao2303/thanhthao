...
<head>
    ...
    <style>
        ...
        .book-detail-header .book-info h1 {
            font-size: 24px;
            margin-bottom: 20px;
            color: #333;
        }

        .book-detail-container .detail-item {
            display: flex;
            margin: 10px 0;
            font-size: 16px;
            color: #333;
        ...
        .book-detail-container .detail-item strong {
            width: 150px;
            color: #555;
            flex-shrink: 0;
        }

        .book-detail-container .detail-item span {
            flex-grow: 1;
        }

        .book-detail-container .rating {
            margin-top: 20px;
        }
        ...
        <div class="content">
            <div class="book-detail-container">
                <div class="book-detail-header">
                    <img src=" https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1647077914i/60596341.jpg" alt="book">
                    <div class="book-info">
                        <h1>{{ $book->tieuDe }}</h1>
                        ...
                        <div class="detail-item">
                            <strong>Nhà xuất bản:</strong><span>{{ $book->nhaXuatBan }}</span>
                        </div>
                        <div class="detail-item">
                            <strong>Năm xuất bản:</strong><span>{{ $book->namXuatBan }}</span>
                        </div>
                        <div class="detail-item">
                        ...
                        <div class="detail-item">
                            <strong>Giá bán:</strong><span>{{ $book->giaBan }}</span>
                        </div>
                        <div class="detail-item">
                            <strong>Hình thức bìa:</strong><span>{{ $book->hinhThucBia }}</span>
                        </div>
                        <div class="detail-item">
                            <strong>Tồn kho:</strong><span>{{ $book->tonKho }}</span>
                        </div>
                        <div class="detail-item">
                            <strong>Số lượng đã bán:</strong><span>{{ $book->soLuongDaBan }}</span>
                        </div>
                    </div>
                </div>
                <div class="detail-item rating">
                    <strong>Mô tả sách:</strong><span>{{ $book->moTaSach }}</span>
                </div>
                <a href="{{ route('books.index') }}" class="btn-back" style="border: 1px solid #888888; margin-left: 80%; margin-top: 120px;">Quay lại</a>
            </div>
        </div>
    </div>
</body>
