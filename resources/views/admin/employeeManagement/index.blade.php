    ...
    <div class="container">
        <div class="sidebar" style="padding-left:0px; padding-right:0px">
            ...
            <ul style="margin-top: 50px;">
                ...
                <li class="no-underline" style="margin-top: 23px;margin-bottom: 23px; margin-left:7px">
                    ...
                    <a href="{{ route('books.index') }}" style="margin-left: 7px;">Quản lý sách</a>
                </li>
                <li class="no-underline">
        ...
        <div class="content">
            <div style="background-color: #fff; width:100%; height: 100%; border: 0.5px solid black">
                <div class="header-container">
                    <h1 style="margin-top:25px; margin-bottom:0px; margin-left:40%">Quản lý nhân viên</h1>
                    @if(session('success'))
                    ...
                    <table>
                        ...
                        <tbody id="employeeTableBody">
                            ...
                            <tr>
                                ...
                                <td class="icon-links">
                                    <a href="{{ route('employees.show', $employee->id) }}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#009900" class="bi bi-eye" viewBox="0 0 16 16">
                                            <path d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8M1.173 8a13 13 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5s3.879 1.168 5.168 2.457A13 13 0 0 1 14.828 8q-.086.13-.195.288c-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5s-3.879-1.168-5.168-2.457A13 13 0 0 1 1.172 8z" />
                                            <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0" />
                                        </svg>
                                    </a>
                                    <a href="{{ route('employees.edit', $employee->id) }}"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="#330099" class="bi bi-pencil-square" viewBox="0 0 16 16">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', (event) => {
            ...
            searchInput.addEventListener('input', function() {
                ...
                fetch(`/employees/search?search=${searchValue}`, {
                        headers: {
